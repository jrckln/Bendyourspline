...
exercises <- list(
  'fp' = list(
    "Basic" =
      c(
        paste0(
          'The aim of this exercise is to understand the impact of individual FP powers on the modeled response function. Reset the inputs. Use BMI ~ Age as variable pair. Make sure that data points, ',
        ...
        paste0(
          ...
          ' to 1 and see how the response curve reacts!'
        ),
        paste0(
          'Set the second power to 2 and move the ',
    ...
    "Advanced" = c(
      ...
      paste0(
        'Make sure that data points and ',
        colorize('LOESS smoother', loesscol) ,
        ' options are turned on and the ',
        colorize('optimal fit', optfitcol) ,
        ' option is turned off. The ',
        colorize('LOESS smoother', loesscol) ,
        ' is a non-parametric function, which produces a smooth function fitting the data. However, it is not easily representable by a mathematical formula. In the plot, the variables exhibit a &Cap; -shaped association.'
      ),
      paste0(
        'The horizontal black line on the bottom is our current response function. Try to move it up to where the ',
        colorize('LOESS smoother', loesscol) ,
      ...
      paste0(
        ...
        colorize('coefficient 1', col[1]) ,
        ' and the intercept to improve the fit. Goodness of fit can be monitored with the R<sup>2</sup> and adjusted R<sup>2</sup> values. Move the sliders of ',
        colorize('coefficient 1', col[1]) ,
        ' and the intercept such that you obtain an adjusted R<sup>2</sup> of at least 0.08.'
      ),
      paste0(
        'Obviously, there is curvature in the ',
        colorize('LOESS smoother', loesscol) ,
        ', which cannot be nicely modelled with a linear response function as obtained in the previous step. Now, set the second power to 2. You can now increase the curvature by moving the slider of ',
        colorize('coefficient 2', col[2]) ,
        ' into the negative range. Hint: enlarge the coefficient range ("Coefficient range: +"). There is also a feature to compute an optimal intercept automatically by clicking "Adjust Intercept automatically". Try to obtain an adjusted R<sup>2</sup> of at least 0.15 by varying both coefficients and the intercept.'
      ),
