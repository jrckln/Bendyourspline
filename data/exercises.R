exercises <- list(
    ...
    'nsp' = list(
        'Advanced'= c(
            ...
            'Increase the coefficient range to -40 and +40, and set coefficient 1,  2 and 3 such that you receive a similar shape like the optimal fit (darkred). Adjust the intercept by hand to calibrate the response function. Can you find coefficients such that the R squared is higher than 0.65?', 
