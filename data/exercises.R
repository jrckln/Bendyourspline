...
exercises <- list(
    'fp' = list(
        "Basic"= 
            c(
            paste0('Reset the inputs. Use BMI ~ Age as dataset. Make sure that data points, ', colorize('optimal fit', optfitcol) , ' and ', colorize('LOESS smoother', loesscol) , ' options are turned off.'),
        ...
        "Advanced" = c(
            'Reset the inputs. In this exercise, we will try to fit a simple regression where we try to describe expected diastolic blood pressure as a function of age. So please select the data set Diastolic blood pressure ~ Age. In the advanced settings of data options, set sample size to "100%" and sex to "Both".', 
    ...
    'nsp' = list(
        'Basic' = c(
            paste0('Reset the inputs. In this exercise, we will examine the effect of individual spline basis functions on the response function. Make sure that data points, ', colorize('optimal fit', optfitcol) , ' and ', colorize('LOESS smoother', loesscol) , ' options are turned off.'),
        ...
        'Advanced'= c(
            'Reset the inputs. In this exercise, we will fit a simple regression where we try to describe expected height as a function of age using natural splines. 
