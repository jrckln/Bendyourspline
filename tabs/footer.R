                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="widget no-box">
                                        <h5> <span></span></h5>
                                        <p> Version  1.0 <br> This work is licensed under a  <a href=https://creativecommons.org/licenses/by/4.0/>CC BY 4.0 license</a></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="widget no-box">
                                        ...
                                        <p><a href="mailto:biometrie@meduniwien.ac.at?subject= ">biometrie@meduniwien.ac.at</a></p>
                                        </ul>
                                    </div>
                                </div>
                            </div>
